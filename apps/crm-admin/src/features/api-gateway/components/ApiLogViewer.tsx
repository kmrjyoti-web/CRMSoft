  ...
  return (
    <div>
      ...
      >
        ...
        <div style={{ width: 170 }}>
          <DatePicker label="From Date" value={fromDate} onChange={(v) => setFromDate(typeof v === 'string' ? v : (v instanceof Date ? v.toISOString().split('T')[0] : ''))} />
        </div>
        <div style={{ width: 170 }}>
          <DatePicker label="To Date" value={toDate} onChange={(v) => setToDate(typeof v === 'string' ? v : (v instanceof Date ? v.toISOString().split('T')[0] : ''))} />
        </div>

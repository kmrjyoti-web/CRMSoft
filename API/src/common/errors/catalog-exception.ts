...
export class CatalogException extends HttpException {
  ...
  static badRequest(errorCode: string, message?: string, details?: any): CatalogException {
  ...
  static conflict(errorCode: string, message?: string, details?: any): CatalogException {

...
export interface IManualTestLogRepository {
  create(data: CreateManualTestLogData): Promise<any>;
  findById(id: string): Promise<any | null>;
  findByTenantId(tenantId: string, filters: ListFilters): Promise<any[]>;
  update(id: string, data: Partial<CreateManualTestLogData>): Promise<any>;
  getSummary(tenantId: string, filters: SummaryFilters): Promise<any>;
}

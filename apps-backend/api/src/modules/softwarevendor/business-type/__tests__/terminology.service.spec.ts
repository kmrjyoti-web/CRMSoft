...
describe('TerminologyService', () => {
  ...
  const mockBusinessTypeRegistry = { findUnique: jest.fn() };
  const mockPrisma = {
    ...
    platform: { businessTypeRegistry: mockBusinessTypeRegistry },
  };
  ...
  describe('getResolved', () => {
    it('should merge business type terms with tenant overrides', async () => {
      ...
      mockBusinessTypeRegistry.findUnique.mockResolvedValue({
        id: 'bt1',

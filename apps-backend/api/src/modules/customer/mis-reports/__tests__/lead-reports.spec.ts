...
(mockPrisma as any).working = mockPrisma;
    ...
    const resolver = { resolveLookupValues: jest.fn().mockImplementation((r: any) => Promise.resolve(r)) } as any;
    report = new LeadFunnelReport(mockPrisma, mockDrillDown, resolver);
  });

...
(prisma as any).working = prisma;
    ...
    const resolver = { resolveLookupValues: jest.fn().mockImplementation((r: any) => Promise.resolve(r)), resolveUser: jest.fn().mockResolvedValue(null) } as any;
    service = new RuleEngineService(prisma, resolver, roundRobin, ownershipCore);
  });

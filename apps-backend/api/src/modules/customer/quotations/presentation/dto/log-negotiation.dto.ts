...
export class LogNegotiationDto {
  ...
  @ApiPropertyOptional() @IsOptional() itemsAdded?: Record<string, unknown>;
  @ApiPropertyOptional() @IsOptional() itemsRemoved?: Record<string, unknown>;
  @ApiPropertyOptional() @IsOptional() itemsModified?: Record<string, unknown>;

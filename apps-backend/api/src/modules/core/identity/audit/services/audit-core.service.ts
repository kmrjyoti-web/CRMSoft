  ...
  async log(params: {
    ...
    try {
      ...
      const entityLabel = this.snapshotService.getEntityLabel(
        params.entityType, params.entityId, (sanitizedAfter || sanitizedBefore) ?? undefined,
      );
      ...
      const auditLog = await this.prisma.identity.auditLog.create({
        data: {
          ...
          beforeSnapshot: sanitizedBefore as any || undefined,
          afterSnapshot: sanitizedAfter as any || undefined,
          ...
          requestBody: sanitizedBody as any || undefined,

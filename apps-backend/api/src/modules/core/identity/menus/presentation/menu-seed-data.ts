...
export const MENU_SEED_DATA: MenuSeedItem[] = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    children: [
      ...
      { name: 'Keyboard Shortcuts', code: 'SET_SHORTCUTS', icon: 'keyboard', route: '/settings/shortcuts', permissionModule: 'settings', permissionAction: 'read' },
      { name: 'Verifications', code: 'SET_VERIFICATIONS', icon: 'shield-check', route: '/settings/verifications', permissionModule: 'settings', permissionAction: 'read' },
    ],
  },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    children: [
      ...
      { name: 'Discovery', code: 'VA_DISCOVERY', icon: 'search', route: '/admin/discovery', permissionModule: 'admin', permissionAction: 'read' },
    ],
  },
];

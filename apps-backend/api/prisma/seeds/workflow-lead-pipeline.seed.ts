...
export async function seedLeadWorkflow(prisma: PrismaClient, adminId: string, tenantId: string) {
  ...
  const states = [
    { name: 'New', code: 'NEW', stateType: 'INITIAL' as const, color: '#94A3B8', sortOrder: 0 },
    { name: 'Verified', code: 'VERIFIED', stateType: 'INTERMEDIATE' as const, color: '#60A5FA', sortOrder: 1 },
    { name: 'Allocated', code: 'ALLOCATED', stateType: 'INTERMEDIATE' as const, color: '#818CF8', sortOrder: 2 },
    { name: 'In Progress', code: 'IN_PROGRESS', stateType: 'INTERMEDIATE' as const, color: '#34D399', sortOrder: 3 },
    { name: 'Demo Scheduled', code: 'DEMO_SCHEDULED', stateType: 'INTERMEDIATE' as const, color: '#F59E0B', sortOrder: 4 },
    { name: 'Quotation Sent', code: 'QUOTATION_SENT', stateType: 'INTERMEDIATE' as const, color: '#F97316', sortOrder: 5 },
    { name: 'Negotiation', code: 'NEGOTIATION', stateType: 'INTERMEDIATE' as const, color: '#A78BFA', sortOrder: 6 },
    { name: 'Won', code: 'WON', stateType: 'TERMINAL' as const, category: 'SUCCESS' as const, color: '#10B981', sortOrder: 7 },
    { name: 'Lost', code: 'LOST', stateType: 'TERMINAL' as const, category: 'FAILURE' as const, color: '#EF4444', sortOrder: 8 },
    { name: 'On Hold', code: 'ON_HOLD', stateType: 'INTERMEDIATE' as const, category: 'PAUSED' as const, color: '#9CA3AF', sortOrder: 9 },
  ];

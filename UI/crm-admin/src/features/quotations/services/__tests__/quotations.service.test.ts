...
describe("quotationsService", () => {
  ...
  it("getById calls GET /quotations/:id", async () => {
    ...
    expect(apiClient.get).toHaveBeenCalledWith("/quotations/q-1");
  });
  ...
  it("create sends POST /quotations", async () => {
    ...
    expect(apiClient.post).toHaveBeenCalledWith("/quotations", payload);
  });

  it("update sends PUT /quotations/:id", async () => {
    const payload = { title: "Updated" };
    await quotationsService.update("q-1", payload);
    expect(apiClient.put).toHaveBeenCalledWith("/quotations/q-1", payload);
  });

  it("cancel sends DELETE /quotations/:id", async () => {
    await quotationsService.cancel("q-1");
    expect(apiClient.delete).toHaveBeenCalledWith("/quotations/q-1");
  });
  ...
  it("addLineItem sends POST /quotations/:id/items", async () => {
    ...
    expect(apiClient.post).toHaveBeenCalledWith("/quotations/q-1/items", payload);
  });
  ...
  it("send sends POST /quotations/:id/send", async () => {
    ...
    expect(apiClient.post).toHaveBeenCalledWith("/quotations/q-1/send", payload);
  });
  ...
  it("accept sends POST /quotations/:id/accept", async () => {
    ...
    expect(apiClient.post).toHaveBeenCalledWith("/quotations/q-1/accept", payload);
  });
  ...
  it("reject sends POST /quotations/:id/reject", async () => {
    ...
    expect(apiClient.post).toHaveBeenCalledWith("/quotations/q-1/reject", payload);
  });

  it("revise sends POST /quotations/:id/revise", async () => {
    await quotationsService.revise("q-1");
    expect(apiClient.post).toHaveBeenCalledWith("/quotations/q-1/revise");
  });
});

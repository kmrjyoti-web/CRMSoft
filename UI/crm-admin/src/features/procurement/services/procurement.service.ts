...
export const procurementService = {
  ...
  createUnit: (data: Record<string, any>) =>
  ...
  createConversion: (data: Record<string, any>) =>
  ...
  updateRFQ: (id: string, data: Record<string, any>) =>
  ...
  updateQuotation: (id: string, data: Record<string, any>) =>
  ...
  // ─── Compare ───
  compareQuotations: (data: Record<string, any>) =>
    api.post<ApiResponse<{ comparison: QuotationComparison; scores: any[]; weights: any }>>(`${BASE}/compare`, data).then((r) => r.data),
  ...
  // ─── Purchase Orders ───
  listPOs: (params?: Record<string, any>) =>
  ...
  // ─── Goods Receipts ───
  listGRN: (params?: Record<string, any>) =>
  ...
  createGRN: (data: Record<string, any>) =>
    api.post<ApiResponse<GoodsReceipt>>(`${BASE}/goods-receipts`, data).then((r) => r.data),
  updateGRN: (id: string, data: Record<string, any>) =>

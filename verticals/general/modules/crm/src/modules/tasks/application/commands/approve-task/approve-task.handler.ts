...
export class ApproveTaskHandler implements ICommandHandler<ApproveTaskCommand> {
  ...
  private async autoCreateActivity(task: Record<string, unknown>, cmd: ApproveTaskCommand) {
    try {
  ...
  private async syncCalendarEvent(task: Record<string, unknown>, cmd: ApproveTaskCommand) {
    try {

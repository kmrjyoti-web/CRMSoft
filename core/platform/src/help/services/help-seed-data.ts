/**
 * Pre-seed help articles: 5 USER + 5 DEVELOPER
 * Uses {product}, {contact}, {organization} terminology placeholders.
 */
export const helpSeedData = [
  // ═══════════════════════════════════════════════════════
  // USER ARTICLES
  // ═══════════════════════════════════════════════════════
  {
    ...
    content:
      'To add a new {contact} in {product}, navigate to the {contact}s module from the sidebar. ' +
  ...
  },
  {
    ...
    content:
      'To create a quotation in {product}, go to the Quotations module. ' +
  ...
  },
  {
    ...
    content:
      'The {product} Leads module provides a powerful Kanban board for visual pipeline management. ' +
  ...
  },
  {
    ...
    content:
      'To enable WhatsApp messaging in {product}, go to Settings > Communication > WhatsApp.\n\n' +
      '**Setup Steps:**\n' +
  ...
  },
  {
    ...
    content:
      'The {product} Dashboard provides a real-time overview of your business metrics.\n\n' +
      '**KPI Cards:**\n' +

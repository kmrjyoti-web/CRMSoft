...
function ProfileInner() {
  ...
  return (
    <PageGuard pageCode="SELF_CARE_PROFILE">
      <div style={{ maxWidth: 700, margin: '0 auto', padding: '32px 24px', fontFamily: 'var(--brand-font-body)' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 28 }}>
          ...
          <div>
            <h1 style={{ fontSize: 20, fontWeight: 700, color: 'var(--brand-text)', margin: 0, fontFamily: 'var(--brand-font-heading)' }}>My Profile</h1>
            <p style={{ fontSize: 13, color: 'var(--brand-text-muted)', margin: 0 }}>Manage your personal information</p>
          </div>
        </div>
        ...
        <div style={{ background: 'var(--brand-card-bg)', border: '1px solid var(--brand-card-border)', borderRadius: 10, padding: 24, boxShadow: 'var(--brand-card-shadow)' }}>
          <p style={{ color: 'var(--brand-text-muted)', fontSize: 14 }}>Profile editing coming soon. Your account details are managed by your platform administrator.</p>
        </div>
      </div>
    </PageGuard>
  );

...
export async function seedTourPlanWorkflow(prisma: PrismaClient, adminId: string, tenantId: string) {
  ...
  const states = [
    ...
    { name: 'Approved', code: 'APPROVED', stateType: 'INTERMEDIATE' as const, category: 'SUCCESS' as const, color: '#10B981', sortOrder: 2 },
    { name: 'Rejected', code: 'REJECTED', stateType: 'TERMINAL' as const, category: 'FAILURE' as const, color: '#EF4444', sortOrder: 3 },
    { name: 'In Progress', code: 'IN_PROGRESS', stateType: 'INTERMEDIATE' as const, color: '#3B82F6', sortOrder: 4 },
    { name: 'Completed', code: 'COMPLETED', stateType: 'TERMINAL' as const, category: 'SUCCESS' as const, color: '#059669', sortOrder: 5 },
    { name: 'Cancelled', code: 'CANCELLED', stateType: 'TERMINAL' as const, category: 'FAILURE' as const, color: '#DC2626', sortOrder: 6 },
  ];

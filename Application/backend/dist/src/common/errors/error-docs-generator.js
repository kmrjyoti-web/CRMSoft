...
exports.generateErrorReference = generateErrorReference;
const error_codes_1 = require("./error-codes");
function generateErrorReference() {
    const lines = [];
    lines.push('# CRM API — Error Code Reference');
    lines.push('');
    lines.push(`> Auto-generated. Total error codes: **${error_codes_1.TOTAL_ERROR_CODES}**`);
    lines.push('');
    ...
    lines.push('');
    const categories = {};
    for (const def of Object.values(error_codes_1.ERROR_CODES)) {
...
if (require.main === module) {
    ...
    console.log(`Total error codes: ${error_codes_1.TOTAL_ERROR_CODES}`);
}
//# sourceMappingURL=error-docs-generator.js.map
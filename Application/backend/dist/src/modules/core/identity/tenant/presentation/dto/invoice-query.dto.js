...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: identity_client_1.PaymentStatus, description: 'Filter by payment status' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(identity_client_1.PaymentStatus),

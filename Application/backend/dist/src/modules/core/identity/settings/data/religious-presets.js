...
exports.DEFAULT_RELIGIOUS_MODE_CONFIG = exports.PUJA_ITEMS = exports.RELIGIOUS_PRESETS = void 0;
exports.RELIGIOUS_PRESETS = {
    HINDU: {
        label: 'Hindu',
        labelHi: 'हिन्दू',
        deities: [
...
exports.DEFAULT_RELIGIOUS_MODE_CONFIG = {
    enabled: false,
    religion: 'HINDU',
    deity: 'GANPATI',
    ...
    pujaItems: ['DEEP', 'AGARBATTI', 'CHANDAN', 'PRASAD', 'PHOOL'],
    soundEnabled: true,
    autoCloseAfterSeconds: 8,
    showOncePerDay: true,
    festivalMode: true,
};
//# sourceMappingURL=religious-presets.js.map
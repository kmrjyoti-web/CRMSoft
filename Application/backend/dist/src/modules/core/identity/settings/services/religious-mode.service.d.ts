...
export declare class ReligiousModeService {
    private readonly prisma;
    private readonly logger;
    constructor(prisma: PrismaService);
    getConfig(tenantId: string): Promise<ReligiousModeConfig>;
    updateConfig(tenantId: string, patch: Partial<ReligiousModeConfig>): Promise<ReligiousModeConfig>;
    getStatus(tenantId: string, userId: string, roleId: string | undefined, role: string): Promise<{
        show: boolean;
    ...
    logInteraction(tenantId: string, userId: string, items: string[], durationSeconds: number, date: string): Promise<void>;

...
export declare class ReligiousModeController {
    private readonly service;
    constructor(service: ReligiousModeService);
    getConfig(req: any): Promise<{
        enabled: boolean;
        religion: import("../data/religious-presets").ReligionCode;
        deity: string;
        officeHours: {
            from: string;
            to: string;
        ...
        pujaItems: import("../data/religious-presets").PujaItemCode[];
        soundEnabled: boolean;
        autoCloseAfterSeconds: number;
        showOncePerDay: boolean;
        festivalMode: boolean;
    }>;
    updateConfig(req: any, body: Partial<ReligiousModeConfig>): Promise<{
        enabled: boolean;
        religion: import("../data/religious-presets").ReligionCode;
        deity: string;
        officeHours: {

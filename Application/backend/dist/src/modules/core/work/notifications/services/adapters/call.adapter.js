...
exports.CallAdapter = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../../../../../../core/prisma/prisma.service");
const error_utils_1 = require("../../../../../../common/utils/error.utils");
let CallAdapter = CallAdapter_1 = class CallAdapter {
    constructor(prisma) {
        this.prisma = prisma;
        this.channel = 'CALL';
        this.logger = new common_1.Logger(CallAdapter_1.name);
    }
    async send(params) {
        try {
            ...
            this.logger.error(`Call initiation failed: ${(0, error_utils_1.getErrorMessage)(error)}`);
            return { success: false, error: (0, error_utils_1.getErrorMessage)(error) };
        }
    }
};
exports.CallAdapter = CallAdapter;
exports.CallAdapter = CallAdapter = CallAdapter_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], CallAdapter);
//# sourceMappingURL=call.adapter.js.map
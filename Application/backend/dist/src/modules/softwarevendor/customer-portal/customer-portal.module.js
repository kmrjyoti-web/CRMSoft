...
const admin_portal_controller_1 = require("./presentation/admin-portal.controller");
const portal_controller_1 = require("./presentation/portal.controller");
...
exports.CustomerPortalModule = CustomerPortalModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [admin_portal_controller_1.AdminPortalController, portal_controller_1.PortalController],

...
var CronSeedService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.CronSeedService = void 0;
...
let CronSeedService = CronSeedService_1 = class CronSeedService {
    constructor(prisma) {
        this.prisma = prisma;
        this.logger = new common_1.Logger(CronSeedService_1.name);
    }
    async onModuleInit() {
        await this.seed();
    }
        ...
        for (const job of SEED_CRON_JOBS) {
            ...
            await this.prisma.working.cronJobConfig.create({
                data: {
                    ...
                    jobParams: 'jobParams' in job ? job.jobParams : undefined,
                    status: ('status' in job ? job.status : 'ACTIVE'),
                },
            });
            created++;
        }
        if (created > 0)
            this.logger.log(`Seeded ${created} cron job configs`);
    }
};
exports.CronSeedService = CronSeedService;
exports.CronSeedService = CronSeedService = CronSeedService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], CronSeedService);
//# sourceMappingURL=cron-seed.service.js.map
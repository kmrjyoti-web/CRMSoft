...
export declare class ReceiptService {
    ...
    constructor(prisma: PrismaService, autoNumber: AutoNumberService, amountInWords: AmountInWordsService);
    generateForPayment(tenantId: string, paymentId: string, userId: string): Promise<{
        id: string;
        tenantId: string;
        createdAt: Date;
        isDeleted: boolean;
    ...
    getById(tenantId: string, receiptId: string): Promise<{
        payment: {
            invoice: {
                id: string;
                tenantId: string;
    ...
    getByPaymentId(tenantId: string, paymentId: string): Promise<{
        payment: {
            invoice: {
                id: string;
                tenantId: string;

...
export declare class GetEntityConversationsHandler implements IQueryHandler<GetEntityConversationsQuery> {
    private readonly prisma;
    constructor(prisma: PrismaService);
    execute(query: GetEntityConversationsQuery): Promise<{
        data: {
            id: string;
            tenantId: string;
            createdAt: Date;

...
let GetTemplatesHandler = class GetTemplatesHandler {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async execute(query) {
...
exports.GetTemplatesHandler = GetTemplatesHandler = __decorate([
    (0, cqrs_1.QueryHandler)(query_1.GetTemplatesQuery),

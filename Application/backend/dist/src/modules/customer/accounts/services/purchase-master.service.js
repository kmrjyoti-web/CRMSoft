...
exports.PurchaseMasterService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../../../../core/prisma/prisma.service");
let PurchaseMasterService = class PurchaseMasterService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    async findById(tenantId, id) {
        ...
        if (!pm)
            throw new common_1.NotFoundException('Purchase master not found');
        return pm;
    }
    async create(tenantId, data) {
        const existing = await this.prisma.working.purchaseMaster.findFirst({ where: { tenantId, code: data.code } });
        if (existing)
            throw new common_1.BadRequestException(`Purchase master code "${data.code}" already exists`);
        if (data.isDefault) {
...
exports.PurchaseMasterService = PurchaseMasterService;
exports.PurchaseMasterService = PurchaseMasterService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], PurchaseMasterService);
//# sourceMappingURL=purchase-master.service.js.map
...
exports.TeamLeaderboardReport = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../../../../../core/prisma/prisma.service");
const drill_down_service_1 = require("../../infrastructure/drill-down.service");
let TeamLeaderboardReport = class TeamLeaderboardReport {
    constructor(prisma, drillDownSvc) {
        this.prisma = prisma;
        this.drillDownSvc = drillDownSvc;
        this.code = 'TEAM_LEADERBOARD';
        this.name = 'Team Leaderboard';
        this.category = 'TEAM';
        this.description = 'Ranked leaderboard of team members by selected performance metric with trend analysis';
    ...
    async generate(params) {
        ...
        const computeMetrics = (uLeads, uActivities, uid) => {
            ...
            const perfScore = Math.round((convRate / 100) * 30 +
        ...
        const metricFormat = rankBy === 'REVENUE' ? 'currency'
            : rankBy === 'CONVERSION_RATE' ? 'percent'
                : 'number';
        const summary = [
...
exports.TeamLeaderboardReport = TeamLeaderboardReport;
exports.TeamLeaderboardReport = TeamLeaderboardReport = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService,
        drill_down_service_1.DrillDownService])
], TeamLeaderboardReport);
//# sourceMappingURL=team-leaderboard.report.js.map
...
exports.IndividualScorecardReport = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../../../../../core/prisma/prisma.service");
const drill_down_service_1 = require("../../infrastructure/drill-down.service");
let IndividualScorecardReport = class IndividualScorecardReport {
    constructor(prisma, drillDownSvc) {
        this.prisma = prisma;
        this.drillDownSvc = drillDownSvc;
        this.code = 'INDIVIDUAL_SCORECARD';
        this.name = 'Individual Scorecard';
        this.category = 'TEAM';
        this.description = 'Comprehensive per-employee scorecard covering leads, activities, demos, quotations, revenue, and efficiency';
...
exports.IndividualScorecardReport = IndividualScorecardReport;
exports.IndividualScorecardReport = IndividualScorecardReport = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService,
        drill_down_service_1.DrillDownService])
], IndividualScorecardReport);
//# sourceMappingURL=individual-scorecard.report.js.map
...
export declare class CreateAssignmentRuleHandler implements ICommandHandler<CreateAssignmentRuleCommand> {
    private readonly prisma;
    private readonly logger;
    constructor(prisma: PrismaService);
    execute(command: CreateAssignmentRuleCommand): Promise<{
        id: string;
        tenantId: string;
        name: string;

...
export declare class ReviseQuotationHandler implements ICommandHandler<ReviseQuotationCommand> {
    private readonly prisma;
    private readonly numberService;
    private readonly logger;
    constructor(prisma: PrismaService, numberService: QuotationNumberService);
    execute(cmd: ReviseQuotationCommand): Promise<{
        lead: {
            id: string;
            tenantId: string;
            isActive: boolean;

...
export declare class AiGenerateQuotationHandler implements ICommandHandler<AiGenerateQuotationCommand> {
    private readonly prisma;
    private readonly numberService;
    private readonly calculator;
    private readonly prediction;
    private readonly logger;
    constructor(prisma: PrismaService, numberService: QuotationNumberService, calculator: QuotationCalculatorService, prediction: QuotationPredictionService);
    execute(cmd: AiGenerateQuotationCommand): Promise<({
        lead: {
            id: string;
            tenantId: string;
            isActive: boolean;

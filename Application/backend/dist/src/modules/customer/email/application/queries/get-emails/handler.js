...
exports.GetEmailsHandler = void 0;
const cqrs_1 = require("@nestjs/cqrs");
const prisma_service_1 = require("../../../../../../core/prisma/prisma.service");
const query_1 = require("./query");
let GetEmailsHandler = class GetEmailsHandler {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async execute(query) {
...
exports.GetEmailsHandler = GetEmailsHandler;
exports.GetEmailsHandler = GetEmailsHandler = __decorate([
    (0, cqrs_1.QueryHandler)(query_1.GetEmailsQuery),

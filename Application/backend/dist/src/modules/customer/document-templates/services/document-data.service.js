...
var DocumentDataService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.DocumentDataService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../../../../core/prisma/prisma.service");
let DocumentDataService = DocumentDataService_1 = class DocumentDataService {
    constructor(prisma) {
        this.prisma = prisma;
        this.logger = new common_1.Logger(DocumentDataService_1.name);
    }
    async getInvoiceData(invoiceId, tenantId) {
    ...
    async getQuotationData(quotationId, tenantId) {
            ...
            case 'RECEIPT':
                return {
                    ...
                    invoice: {
                        ...
                        termsAndConditions: 'Payment due within 30 days. Late payments attract 1.5% per month interest.',
                        bankName: 'HDFC Bank',
            ...
            case 'QUOTATION':
                return {
                    ...
                    quotation: {
                        ...
                        termsConditions: 'This quotation is valid for 30 days from the date of issue.',
                    },
                };
            case 'PURCHASE_ORDER':
...
exports.DocumentDataService = DocumentDataService = DocumentDataService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], DocumentDataService);
//# sourceMappingURL=document-data.service.js.map
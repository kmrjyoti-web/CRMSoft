...
const prisma = new global_reference_client_1.PrismaClient();
const COUNTRIES = [
...
async function main() {
    ...
    if (!india)
        throw new Error('India country record not found');
    ...
    for (const [stateCode, cities] of Object.entries(INDIAN_CITIES)) {
        ...
        if (!state) {
            console.warn(`  State ${stateCode} not found, skipping cities`);
            continue;
        }
...
//# sourceMappingURL=global-reference-seed.js.map
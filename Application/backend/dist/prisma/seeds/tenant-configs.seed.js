...
exports.seedTenantConfigs = seedTenantConfigs;
const SEED_CONFIGS = [
    { category: 'GENERAL', configKey: 'timezone', configValue: 'Asia/Kolkata', defaultValue: 'Asia/Kolkata', valueType: 'STRING', displayName: 'Timezone', groupName: 'Regional', sortOrder: 1 },
    { category: 'GENERAL', configKey: 'currency', configValue: 'INR', defaultValue: 'INR', valueType: 'ENUM', displayName: 'Currency', groupName: 'Regional', sortOrder: 2, enumOptions: ['INR', 'USD', 'EUR', 'GBP', 'AED', 'SGD', 'AUD'] },
    ...
    { category: 'NUMBERING', configKey: 'leadNumberFormat', configValue: '{PREFIX}-{YYYYMM}-{SEQ}', defaultValue: '{PREFIX}-{YYYYMM}-{SEQ}', valueType: 'STRING', displayName: 'Lead Number Format', groupName: 'Number Formats', sortOrder: 2 },
    ...
    { category: 'NUMBERING', configKey: 'sequenceResetPolicy', configValue: 'MONTHLY', defaultValue: 'MONTHLY', valueType: 'ENUM', displayName: 'Sequence Reset Policy', groupName: 'Number Formats', sortOrder: 7, enumOptions: ['NEVER', 'MONTHLY', 'YEARLY'] },
    ...
    { category: 'BUSINESS_HOURS', configKey: 'workStartTime', configValue: '09:00', defaultValue: '09:00', valueType: 'STRING', displayName: 'Work Start Time', groupName: 'Schedule', sortOrder: 2 },
    { category: 'BUSINESS_HOURS', configKey: 'workEndTime', configValue: '18:00', defaultValue: '18:00', valueType: 'STRING', displayName: 'Work End Time', groupName: 'Schedule', sortOrder: 3 },
    { category: 'BUSINESS_HOURS', configKey: 'holidays', configValue: '[]', defaultValue: '[]', valueType: 'JSON', displayName: 'Holiday Calendar', groupName: 'Schedule', sortOrder: 4 },
    { category: 'LEAD_SETTINGS', configKey: 'autoAssignEnabled', configValue: 'false', defaultValue: 'false', valueType: 'BOOLEAN', displayName: 'Enable Auto-Assignment', groupName: 'Assignment', sortOrder: 1 },
    ...
    { category: 'LEAD_SETTINGS', configKey: 'leadExpiryDays', configValue: '90', defaultValue: '90', valueType: 'INTEGER', displayName: 'Lead Expiry (Days)', groupName: 'Lifecycle', sortOrder: 4, minValue: 7, maxValue: 365 },
    ...
    { category: 'LEAD_SETTINGS', configKey: 'requireLostReason', configValue: 'true', defaultValue: 'true', valueType: 'BOOLEAN', displayName: 'Require Lost Reason', groupName: 'Rules', sortOrder: 6 },
    ...
    { category: 'NOTIFICATION', configKey: 'digestRecipients', configValue: '[]', defaultValue: '[]', valueType: 'JSON', displayName: 'Digest Recipients', groupName: 'Digest', sortOrder: 5 },
    ...
    { category: 'SECURITY', configKey: 'enforcePasswordComplexity', configValue: 'true', defaultValue: 'true', valueType: 'BOOLEAN', displayName: 'Enforce Password Complexity', groupName: 'Password Policy', sortOrder: 4 },
...
async function seedTenantConfigs(prisma, tenantId) {
    ...
    console.log(`✅ ${seeded} tenant configs seeded`);
}
//# sourceMappingURL=tenant-configs.seed.js.map
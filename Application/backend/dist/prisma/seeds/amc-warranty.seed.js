...
exports.seedAmcWarranty = seedAmcWarranty;
async function seedAmcWarranty(prisma) {
    const warrantySeeds = [
        ...
        if (!existing) {
            await prisma.warrantyTemplate.create({
                data: {
                    ...
                    supportChannels: seed.supportChannels ?? [],
                    serviceCharge: seed.serviceCharge ?? 0,
...
//# sourceMappingURL=amc-warranty.seed.js.map
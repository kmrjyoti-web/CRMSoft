...
exports.seedTaskEngine = seedTaskEngine;
async function seedTaskEngine(prisma) {
    const configs = [
        {
    ...
    for (const nc of notifConfigs) {
        await prisma.notificationConfig.upsert({
            ...
            create: { tenantId: '', eventCode: nc.eventType, eventType: nc.eventType, channels: nc.channels },
        });
    }
...
//# sourceMappingURL=task-engine.seed.js.map
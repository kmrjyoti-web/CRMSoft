...
exports.seedPermissionTemplates = seedPermissionTemplates;
...
async function seedPermissionTemplates(prisma) {
    let count = 0;
    for (const t of exports.PERMISSION_TEMPLATES) {
...
//# sourceMappingURL=permission-templates.seed.js.map